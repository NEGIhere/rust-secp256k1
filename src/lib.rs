...
//! and its derivatives. But since at present default hash function (SHA256)
//! is not, considered crypto-resistant it has been replaced with
//! post-quantum hash function SHA3 (Keccak).
//!

#![crate_type = "lib"]
#![crate_type = "rlib"]
#![crate_type = "dylib"]
#![crate_name = "secp256k1-sha3"]
